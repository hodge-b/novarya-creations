        ...
        <>
            ...
            <div className="p-5 mt-5 container shadow rounded" style={{backgroundColor: "#fff"}}>
                ...
                <div className="mt-5 container">
                    <button className="me-5 btn shadow-sm text-info" onClick={onclick}>Update</button>
                    <button className="mx-5 btn shadow-sm text-info" onClick={onclick}>Cancel</button>
                </div>
            </div>
        </>
    )
